...
namespace WebsitePresentation.Data.Migrations
{
    ...
    [Migration("20221012092608_ImplementDatabase")]
            ...
            modelBuilder.Entity("Model.SectionPostAnswerStep", b =>
                {
                    ...
                    b.Property<int?>("SectionPostStepId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.SectionPostAnswerStep", b =>
                {
                    ...
                    b.HasOne("Model.SectionPostStep", null)
                        .WithMany("SectionPostAnswerSteps")
                        .HasForeignKey("SectionPostStepId");
